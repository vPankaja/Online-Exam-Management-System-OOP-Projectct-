            ...
            <div class = "main">
                ...
                <form id="form" method = "post" action = "<%=request.getContextPath()%>/LecturerEditServlet">
                    ...
                    <div class="form-control">
                        ...
                        <input class ="ID "type="text" name="staffId" value="<%=request.getParameter("staffId")%>">

                        <h2 class ="name"> N.I.C</h2>
                        <input class="NIC" type="text" name="NIC" value="<%=request.getParameter("NIC")%>">

                        <h2 class ="name">Name</h2>
                        <input class ="FullName" type ="text" name="name" value="<%=request.getParameter("name")%>">

                        <h2 class="name">Section</h2>
                        <input class="Section" type="text" name="section" value="<%=request.getParameter("section")%>">

                        <h2 class="name">E-Mail </h2>
                        <input class="Email" type="text" name="email" value="<%=request.getParameter("email")%>">

                        <h2 class="name"> username</h2>
                        <input class ="Username" type="text" name="username" value="<%=request.getParameter("username")%>">

                        <h2 class="name">password</h2>
                        <input class ="Password" type="password" name="password" value="<%=request.getParameter("password")%>"><br>
